# weed420 EPK — Site Content

Edit this note to update the text displayed on the site. Sections marked with `()` pull from data files.
...
## Press (id: press)
- **Eyebrow:** Press
- **Reviews:** (array in src/data/constants.ts — PRESS)

---

## Listen / Platforms (id: music)
- **Eyebrow:** Listen
- **Platforms:** (array in src/data/constants.ts — PLATFORMS)
...
- **EPs heading:** EPs & Singles
- **Releases:** (array in src/data/discography.ts — releases)

---

## Tour Dates (id: tour)
- **Eyebrow:** Tour Dates
- **Empty state:** No upcoming tour dates
- **Dates:** (fetched from Google Sheets at build time)

---

## Footer / Contact (id: booking)
- **Eyebrow:** Contact
